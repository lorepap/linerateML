...
def ml_model(alu_config, is_sram, transient, log=False):
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(
		description='This program prints out a breakdown of the table size in each compute Layer.')
	...
	if args.tcam:
		ml_model(args.muxed_alu_config, False, args.transient, True)
	elif args.sram:
		ml_model(args.muxed_alu_config, True, args.transient, True)

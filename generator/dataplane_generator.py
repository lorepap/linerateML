from generator.sram import ml_sram_gen
from generator.tcam import ml_tcam_gen
...
def main():
	...
	if args.tcam:
		code = ml_tcam_gen(args.sub_tree, layers, args.features, args.leaf_limit, args.transient)
	elif args.sram:
		code = ml_sram_gen(args.sub_tree, layers, args.features, args.transient)
